...
jQuery(function ($) {
  ...
  var swiper = new Swiper(".js-fvSwiper", {
    loop: true,
  ...
  var swiper2 = new Swiper(".js-cardSwiper", {
    slidesPerView: "1.264",
    spaceBetween: 20,
    loop: true,
  ...
  $(document).ready(function () {
    ...
    $(trigger).click(function () {
      ...
      var imgAlt = $(this).find("img").attr("alt"); // alt テキストを取得（アクセシビリティ向上）

      // モーダルに挿入する画像のHTMLを作成
      var modalImage = "<img src=\"".concat(imgSrc, "\" alt=\"").concat(imgAlt, "\" class=\"modal__image\">");
  ...
  $(document).ready(function () {
    ...
    function switchTab(selectedTab) {
      ...
      $(".info-tags__tag[data-tab='" + selectedTab + "']").addClass("tag-active");
    ...
    // 初期状態の設定
    function initTab() {
      var activeTab = localStorage.getItem("activeTab") || getParameterByName("tab");
      if (!activeTab) {
